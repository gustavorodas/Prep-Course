...
//console.log(agregarItemAlFinalDelArray([1,2,4],6))
...
//if (arrayContiene(array,"Enero") && arrayContiene(array,"Marzo") && arrayContiene(array,"Noviembre")) return "No se encontraron los meses pedidos";
}
